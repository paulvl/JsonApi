...
class MakeNestedController extends Command
{
     ...
     * @var string
     */
    protected $signature = 'json-api:make-nested-controller {name}';
     ...
     * @var string
     */
    protected $description = 'Create a new json-api nested controller class';
    ...
    protected function makeController()
    {
        ...
        if ($this->files->exists($path = $this->getControllerPath($name))) {
            return $this->error('Nested Controller already exists!');
        }
        ...
        $this->info("   Route::resource('$classname_lc.relation', '$classname', ['except' => ['store', 'update', 'destroy', 'create', 'edit']]);");
